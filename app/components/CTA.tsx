  ...
  return (
    <section className="bg-gray-shade py-20">
      <div className="max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
        ...
        <button className="text-white text-sm bg-blue-600 transition-transform duration-200 hover:scale-110 hover:cursor-pointer active:bg-blue-300 rounded-xs py-2 px-4 flex justify-center items-center"> Request Demo <ArrowRight size={16} /> </button>
      </div>
    </section>
  )
}
