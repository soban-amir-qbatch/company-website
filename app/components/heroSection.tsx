      ...
      <div className="relative z-10 px-6 py-20 max-w-4xl mx-auto flex flex-col md:flex-row items-center text-center md:text-left">
        <div className="flex-1">
          ...
          <div className="mt-6 w-2/3 flex flex-col md:flex-row gap-4">
            <button className="text-white text-sm bg-blue-600 rounded-xs py-2 w-1/2 flex justify-center items-center"> Request Demo <ArrowRight size={16} /> </button>
            <button className="text-white text-sm bg-secondary rounded-xs py-2 w-1/2 flex justify-center items-center"> Explore Product <ArrowRight size={16} /> </button>
          </div>
        </div>
